...
(function( window, undefined ) { /* override window object and undefined */
    console.log("injectClearly() start");
    //  set main objects
    //  ================
        var $C = { 'version': '3335.890.162' };
        var $ = window.jQueryForClearlyComponent;
        console.log("jquery instance="+window.jQueryForClearlyComponent);
    ...
    //  ========================
        ...
        {
        console.log("clearly.getContentElementAndHTML()");
