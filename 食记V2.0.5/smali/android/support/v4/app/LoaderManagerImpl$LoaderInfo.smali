...
# interfaces
.implements Landroid/support/v4/a/k;
...
.field mLoader:Landroid/support/v4/a/j;
...
# virtual methods
.method final callOnLoadFinished(Landroid/support/v4/a/j;Ljava/lang/Object;)V
    .locals 4
    .parameter
    .parameter
    ...
    invoke-static {p2}, Landroid/support/v4/a/j;->a(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoadFinished(Landroid/support/v4/a/j;Ljava/lang/Object;)V
    :try_end_0
...
.method final destroy()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/j;
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/j;

    invoke-interface {v0, v3}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoaderReset(Landroid/support/v4/a/j;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 349
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/j;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/a/j;->a(Landroid/support/v4/a/k;)V

    .line 354
    :cond_3
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/j;

    invoke-virtual {v0}, Landroid/support/v4/a/j;->d()V
...
.method public final dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p3}, Landroid/support/v4/a/j;->a(Ljava/lang/String;Ljava/io/PrintWriter;)V
...
.method final finishRetain()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/a/j;Ljava/lang/Object;)V
...
.method public final onLoadComplete(Landroid/support/v4/a/j;Ljava/lang/Object;)V
    .locals 5
    .parameter
    .parameter
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/c/d;
    ...
    iget-object v1, v1, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/c/d;

    iget v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mId:I

    invoke-virtual {v1, v2, v4}, Landroid/support/v4/c/d;->a(ILjava/lang/Object;)V
    ...
    .line 395
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/a/j;Ljava/lang/Object;)V

    .line 405
    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->this$0:Landroid/support/v4/app/LoaderManagerImpl;

    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/c/d;
...
.method final start()V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Landroid/support/v4/a/j;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/j;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/j;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v4/a/j;->a(ILandroid/support/v4/a/k;)V
